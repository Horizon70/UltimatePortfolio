...
//
//  Created by Davide Fabretti on 19/07/24.
//
...
final class ExtensionTests: BaseTestCase {
    ...
    func testTagSortingIsStable() {
        ...
        tag2.name = "B Tag"
        tag2.id = UUID(uuidString: "FFFFFFFF-FFFF-4164-9AFD-71DD23EA2B1E")
    ...
    func testDecodingDictionary() {
        ...
        XCTAssertEqual(data.count, 3, "There shuld be three items decoded from DecodableDictionary.json")
